...
NDefines.NMilitary.FIELD_MARSHAL_DIVISIONS_CAP = 0 -- 0 means infinity
...
NDefines.NAir.AA_INDUSTRY_AIR_DAMAGE_FACTOR = 0.15---0.12	5x levels = 60% defense from bombing
