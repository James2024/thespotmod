...
---Country
NDefines.NCountry.SPECIAL_FORCES_CAP_MIN = 126
NDefines.NCountry.SPECIAL_FORCES_CAP_BASE = 0.10
NDefines.NCountry.SUPPLY_BASE_MULT = 1.4
---Military
...
NDefines.NMilitary.PLAYER_ORDER_PLANNING_DECAY = 0.4
---XP for leaders
...
NDefines.NMilitary.UNIT_LEADER_ASSIGN_TRAIT_COST = 15.0
...
NDefines.NMilitary.WITHDRAWING_SPEED_FACTOR = 0.2				-- speed bonus when withdrawing
---Navy
...
---NDefines.NNavy.NAVY_VISIBILITY_BONUS_ON_RETURN_FOR_REPAIR = 0.6          removed temporarily to see if it caused bugs
